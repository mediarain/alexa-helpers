...
function Reply(msg, directives) {
  if(_.isArray(msg)) return _.reduce(msg.slice(1), (soFar,msg) => soFar.append(msg) , new Reply(msg[0]))
  this.msg = {
    statements: [],
    reprompt: '',
    card: null,
    yield: false,
    hasAnAsk: false,
    directives: typeof directives !== "undefined" ? directives : {}
  };
  this.append(msg);
}
...
Reply.prototype.write = function (response, intent) {
